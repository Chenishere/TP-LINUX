...
if [[ (-d "$dl") && (-d "$log")]]; then
	...
	youtube-dl -o "$way/description/$title" --skip-download --youtube-skip-dash-manifest "https://www.youtube.com/watch?v=G_1IyYRdLBA" > "/dev/null"
